...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			<!-- Logo -->
			<a href="/ams/owner_login" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>A</b>MS</span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b></b>AMS</span>
			</a>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-right">
										<a href="/ams/owner_login" class="btn btn-default btn-flat">Sign
											In</a>
									</div>
								</li>
							</ul></li>
					...
					<div class="row">
						...
						<div class="col-md-11">
							<div class="box box-primary">
								...
								<!-- /.box-header -->
								<!-- form start -->
								<form role="form" name="add_user_form" id="add_user_form"
									...
									<div class="box-body">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="flatwing"><span class="errorStar">*</span>Status
														:</label> <select id="user_role" name="user_role"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="registerdate"><span class="errorStar">*</span>Register
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="registerdate"><span class="errorStar">*</span>End
														Date :</label> <input type="date" class="form-control"
