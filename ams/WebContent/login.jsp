	...
	<div class="limiter">
		<div class="container-login100"
			...
			<div class="wrap-login100">
				 <form class="login100-form validate-form" action="/ams/login/validateLogin" method="post"  id="login_form">
				
					<span class="login100-form-logo"> <i
						class="zmdi zmdi-landscape"></i>
					</span> <span class="login100-form-title p-b-34 p-t-27"> Log in Admin</span>
					...
					<div class="text-center p-t-90">
						<br> <a class="txt1" href="/ams/forget_pass">Forgot Password?</a><br> 
						<a class="txt1" href="/ams/add_admin">Register Here!</a>
					</div>
				</form>
			</div>
		</div>
