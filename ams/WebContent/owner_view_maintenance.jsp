...
<script type="text/javascript">
	...
	function viewFunction(maintenanceId, dateOfMaintenance, Month, Year,
		...
		document.getElementById("view_maintenace_Year").innerHTML = Year;
													...
													<td class="text-center"><a data-placement="top"
														data-toggle="tooltip" title="View">
															<button class="btn btn-primary btn-xs" data-title="view"
																...
																onclick="viewFunction('${list.maintenanceId}','${list.dateOfMaintenance}','${list.month}','${list.year}','${list.maintenanceType}','${list.maintenanceamount}','${list.duedate}','${list.maintenancedetails}')">
																<span class="glyphicon glyphicon-th-list"></span>
															</button>
													</a> <a data-placement="top" data-toggle="tooltip" title="Edit">
															<button class="btn btn-primary btn-xs" data-title="Edit"
																data-toggle="modal" data-target="#edit"
																onclick="editFunction('${list.maintenanceId}','${list.dateOfMaintenance}','${list.month}','${list.year}','${list.maintenanceType}','${list.maintenanceamount}','${list.duedate}','${list.maintenancedetails}')">
										...
										<form action="ams/maintenance/updateMaintenance/"
											...
											<div class="form-group">
												<label>Year :</label> <input class="form-control "
													id="maintenace_Year" name="maintenace_Year" type="text">
											</div>
