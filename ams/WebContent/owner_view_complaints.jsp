...
<script type="text/javascript">
	...
	'${list.complainId}', '${list.complainDate}', '${list.complainTitle}',
			'${list.complainDescription}'
	function editFunction(complainId, complainDate, complainTitle,
			complainDescription) {
	...
	/* view function */
	function viewFunction(complainId, complainDate, complainTitle,
			complainDescription) {
													...
													<td class="text-center"><a data-placement="top"
														data-toggle="tooltip" title="View">
															<button class="btn btn-primary btn-xs" data-title="view"
																...
																onclick="viewFunction('${list.complainId}', '${list.complainDate}',
															...
															<button class="btn btn-primary btn-xs" data-title="Edit"
																...
																onclick="editFunction('${list.complainId}', '${list.complainDate}',
																							'${list.complainTitle}', '${list.complainDescription}')">
