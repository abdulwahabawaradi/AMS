...
<script type="text/javascript">
	...
	'${list.maintenanceId}', '${list.maintenanceTitle}',
			'${list.dateOfMaintenance}', '${list.maintenanceamount}',
			'${list.maintenancedetails}'
	function editFunction(maintenanceId, maintenanceTitle, dateOfMaintenance,
			maintenanceamount, maintenancedetails) {
		$('#maintenace_title').val(maintenanceTitle);
	...
	function viewFunction(maintenanceId, maintenanceTitle, dateOfMaintenance,
			maintenanceamount, maintenancedetails) {
		document.getElementById("view_maintenace_title").innerHTML = maintenanceTitle;
		document.getElementById("view_date_of_maintenance").innerHTML = dateOfMaintenance;
		document.getElementById("view_maintenance_amount").innerHTML = maintenanceamount;
													...
													<td class="text-center"><a data-placement="top"
														data-toggle="tooltip" title="view">
															<button class="btn btn-primary btn-xs" data-title="view"
																...
																onclick="viewFunction('${list.maintenanceId}','${list.maintenanceTitle}','${list.dateOfMaintenance}','${list.maintenanceamount}','${list.maintenancedetails}')">
																<span class="glyphicon glyphicon-th-list"></span>
															</button>
													</a> <a data-placement="top" data-toggle="tooltip" title="Edit">
															<button class="btn btn-primary btn-xs" data-title="Edit"
																data-toggle="modal" data-target="#edit"
																onclick="editFunction('${list.maintenanceId}','${list.maintenanceTitle}','${list.dateOfMaintenance}','${list.maintenanceamount}','${list.maintenancedetails}')">
									...
									<div class="modal-body">
										<form action="ams/maintenanceExpenses/update/" method="post"
											...
											<div class="form-group">
												<label>Maintenance Title :</label> <input
													class="form-control " id="maintenace_title"
													name="maintenace_title" type="text" readonly>
											</div>
